...
# data file for input
write.table(combo_multiple_comp, '../processed_data/data_tables/Figure4A.txt')
```
...
# data file for input
write.table(test, '../processed_data/data_tables/Figure4B1.txt')
...
# data file for input
write.table(fc, '../processed_data/data_tables/Figure4B2.txt')
```
...
# data file for input
write.table(steric_box, '../processed_data/data_tables/Figure4C.txt')
```
...
# data file for input
write.table(data, '../processed_data/data_tables/Figure4D.txt')
