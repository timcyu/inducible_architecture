...
```{r}
# Figure S5: Pmultiple supplement - Induced/Uninduced comparison with Pcombo heatmap
temp <- induce_combo
...
ggsave('../FigureSX/FigureS5.pdf', width = 15.5, height = 10)

# save data table as input
write.table(combo_multiple_comp, '../source_data/FigureS5.txt', quote = F, row.names = F, sep = '\t')
```

```{r}
# Figure S6: Pspacer Supp
...
# save data table as input
write.table(induce_distal, '../source_data/FigureS6.txt', quote = F, row.names = F, sep = '\t')
```
...
# save data table as input
write.table(steric_box, '../source_data/FigureS7_A.txt', quote = F, row.names = F, sep = '\t')
write.table(induce_steric, '../source_data/FigureS7_BC.txt', quote = F, row.names = F, sep = '\t')
```
...
# save data table as input
write.table(library_comp, '../source_data/FigureS8.txt', quote = F, row.names = F, sep = '\t')
```
...
# save data table as input
write.table(titration, '../source_data/FigureS9.txt', quote = F, row.names = F, sep = '\t')
```
