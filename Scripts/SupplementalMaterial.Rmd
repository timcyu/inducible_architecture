...
write.table(induce_exp, '../processed_data/data_tables/FigureS2.txt')
...
# save data table as input
write.table(induce_combo, '../processed_data/data_tables/FigureS3.txt')
```
...
# save data table as input
write.table(combo_multiple_comp, '../processed_data/data_tables/FigureS5.txt')
```
...
# save data table as input
write.table(induce_distal, '../processed_data/data_tables/FigureS6.txt')
```
...
# save data table as input
write.table(steric_box, '../processed_data/data_tables/FigureS7_A.txt')
write.table(induce_steric, '../processed_data/data_tables/FigureS7_BC.txt')
```
...
# save data table as input
write.table(library_comp, '../processed_data/data_tables/FigureS8.txt')
```
...
# save data table as input
write.table(titration, '../processed_data/data_tables/FigureS9.txt')
```
